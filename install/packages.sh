...
core_packages=(
  # Core
  base base-devel linux-headers linux-firmware sof-firmware networkmanager git

  # Desktop
  hyprland hyprsunset hyprlock hyprshot hyprpicker hypridle waybar ly
  ...
  mako dolphin rofi rofimoji stow awww terminus-font wl-clipboard wl-clip-persist
  # XDG portals
  xdg-desktop-portal-gtk xdg-desktop-portal-kde xdg-desktop-portal-hyprland xdg-user-dirs xdg-utils
  udisks2-btrfs qt6-wayland qt5-wayland
